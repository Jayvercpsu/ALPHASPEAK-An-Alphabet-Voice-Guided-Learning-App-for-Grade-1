...
class HardScoreHistoryScreen extends StatefulWidget {
  final int initialScore;
  final Function
      resetScore; // Callback for resetting the score in the parent widget

  HardScoreHistoryScreen(
      {required this.initialScore, required this.resetScore});

  @override
  _HardScoreHistoryScreen createState() => _HardScoreHistoryScreen();
}

class _HardScoreHistoryScreen extends State<HardScoreHistoryScreen> {
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                _buildButton('Reset Score', Colors.redAccent, Icons.refresh,
                    () async {
                  await _playTapSound();
                ...
                SizedBox(height: 30),
                _buildButton(
                    'Back to Game', Colors.blueAccent, Icons.arrow_back,
                    () async {
                  await _playTapSound();
